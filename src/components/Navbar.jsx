            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-white px-4 py-3 shadow-md ">
                ...
                <div className="lg:hidden flex justify-between items-center relative">
                    ...
                    <div className="relative">
                        ...
                        <div className={`absolute right-0 mt-6 w-40 bg-white border border-gray-300 rounded-md shadow-xl transition-all duration-300 ${isMobileMenuOpen ? 'max-h-100 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
